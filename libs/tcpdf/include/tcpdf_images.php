...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	 ...
	 * @return array|false structure containing the image stepsData
	 * @public static
	 */
	public static function _parsejpeg($file) {
		...
		return array('w' => $a[0], 'h' => $a[1], 'ch' => $channels, 'icc' => $icc, 'cs' => $colspace, 'bpc' => $bpc, 'f' => 'DCTDecode', 'stepsData' => $data);
	}
	...
	public static function _parsepng($file) {
		...
		//Scan chunks looking for palette, transparency and image stepsData
		$pal = '';
		$trns = '';
		$data = '';
		$icc = false;
		...
		fclose($f);
		return array('w' => $w, 'h' => $h, 'ch' => $channels, 'icc' => $icc, 'cs' => $colspace, 'bpc' => $bpc, 'f' => 'FlateDecode', 'parms' => $parms, 'pal' => $pal, 'trns' => $trns, 'stepsData' => $data);
	}
