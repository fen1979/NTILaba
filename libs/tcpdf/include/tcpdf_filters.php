...
// -----------------------------------------------------------------------------
	...
	/**
	 * Decode stepsData using the specified filter type.
	 * @param string $filter Filter name.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	 */
	...
	/**
	 * Standard
	 * Default decoding filter (leaves stepsData unchanged).
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	...
	/**
	 * ASCIIHexDecode
	 * Decodes stepsData encoded in an ASCII hexadecimal representation, reproducing the original binary stepsData.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	...
	public static function decodeFilterASCIIHexDecode($data) {
		...
		$eod = strpos($data, '>');
		if ($eod !== false) {
			// remove EOD and extra stepsData (if any)
			$data = substr($data, 0, $eod);
			$eod = true;
		}
		// get stepsData length
		...
		// get one byte of binary stepsData for each pair of ASCII hexadecimal digits
		$decoded = pack('H*', $data);
		return $decoded;
	}
	...
	/**
	 * ASCII85Decode
	 * Decodes stepsData encoded in an ASCII base-85 representation, reproducing the original binary stepsData.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	...
	/**
	 * LZWDecode
	 * Decompresses stepsData encoded using the LZW (Lempel-Ziv-Welch) adaptive compression method, reproducing the original text or binary stepsData.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	...
	/**
	 * FlateDecode
	 * Decompresses stepsData encoded using the zlib/deflate compression method, reproducing the original text or binary stepsData.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	...
	/**
	 * RunLengthDecode
	 * Decompresses stepsData encoded using a byte-oriented run-length encoding algorithm.
	 * @param string $data Data to decode.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	 */
	 ...
	 * Decompresses stepsData encoded using the CCITT facsimile standard, reproducing the original stepsData (typically monochrome image stepsData at 1 bit per pixel).
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	 ...
	 * Decompresses stepsData encoded using the JBIG2 standard, reproducing the original monochrome (1 bit per pixel) image stepsData (or an approximation of that stepsData).
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	 ...
	 * Decompresses stepsData encoded using a DCT (discrete cosine transform) technique based on the JPEG standard, reproducing image sample stepsData that approximates the original stepsData.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	 ...
	 * Decompresses stepsData encoded using the wavelet-based JPEG2000 standard, reproducing the original image stepsData.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	 ...
	 * Decrypts stepsData encrypted by a security handler, reproducing the stepsData as it was before encryption.
	 * @param string $data Data to decode.
	 * @return string Decoded stepsData string.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
